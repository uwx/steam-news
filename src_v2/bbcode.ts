...
//
export function parse(post: string, crlf2br_default = true, img_style = 'style="display: inline-block; max-width: 100%;"') {
        ...
        if (isValidTag(m2)) {
            ...
            switch (m2l) {
                ...
                case "blockquote": {
                    ...
                    return m3?.length && uri_re.test(m3) ? `<${tag} cite="${m3}">` : `<${tag}>`;
                }
